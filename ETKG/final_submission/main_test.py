...
class TKGBuilder:
    ...
    def process_users(self, users_data):
        ...
        for user_data in users_data:
            ...
            print(f"Đã xử lý user: {user.user_id}")
    ...
    def process_questions_and_options(self, questions_data, options_data):
        ...
        for question_data in questions_data:
            ...
            print(f"Đã xử lý question: {question.id}")
        ...
        for option_data in options_data:
            ...
            print(f"Đã xử lý option: {option.id}")
    ...
    def process_user_options(self, users_data, questions_data, options_data):
        ...
        for user_data in users_data:
            ...
            print(f"Đã xử lý mối quan hệ cho user: {user_id}")
    ...
    def process_entries(self, entries_data):
        ...
        # Chỉ xử lý 10 entry đầu tiên để kiểm thử
        entries_data = entries_data[:10]
        ...
        for entry_data in entries_data:
            ...
            print(f"Đã xử lý entry: {entry.entry_id}")
    ...
    def process_concepts(self, concepts_data):
        ...
        for item in result:
            ...
            for page in pages:
                ...
                print(f"Đã xử lý concept cho entry: {entry_id}")
